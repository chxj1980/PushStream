...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local/cellar/ffmpeg --extra-cflags=-I/usr/local/cellar/ffmpeg_build/include --extra-ldflags=-L/usr/local/cellar/ffmpeg_build/lib --extra-libs=-ldl --bindir=/usr/bin --enable-version3 --enable-zlib --enable-pic --enable-gpl --enable-nonfree --enable-pthreads --enable-libfdk_aac --enable-libfreetype --enable-libmp3lame --enable-libopus --enable-libvorbis --enable-libvpx --enable-libx264"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/usr/local/cellar/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/cellar/ffmpeg/share/ffmpeg"

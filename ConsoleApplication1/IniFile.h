...
inline static int read_config_string(const char *section, const char *key, char *value,
...
inline static int read_config_int(const char *section, const char *key, int default_value,
	const char *file)
{
	char value[32] = { 0 };
	if (!read_config_string(section, key, value, sizeof(value), NULL, file))
	{
...
inline static int write_config_string(const char *section, const char *key,
